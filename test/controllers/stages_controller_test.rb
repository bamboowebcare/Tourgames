...
class StagesControllerTest < ActionController::TestCase
  ...
  test "should create stage" do
    assert_difference('Stage.count') do
      post :create, stage: { dates: @stage.dates, distance: @stage.distance, finish: @stage.finish, name: @stage.name, start: @stage.start, type: @stage.type }
    end
  ...
  test "should update stage" do
    patch :update, id: @stage, stage: { dates: @stage.dates, distance: @stage.distance, finish: @stage.finish, name: @stage.name, start: @stage.start, type: @stage.type }
    assert_redirected_to stage_path(assigns(:stage))
  end
