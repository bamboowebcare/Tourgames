...
class RidersControllerTest < ActionController::TestCase
  ...
  test "should create rider" do
    assert_difference('Rider.count') do
      post :create, rider: { CyclingTeams_id: @rider.CyclingTeams_id, birthday: @rider.birthday, country: @rider.country, name: @rider.name, tdf: @rider.tdf }
    end
  ...
  test "should update rider" do
    patch :update, id: @rider, rider: { CyclingTeams_id: @rider.CyclingTeams_id, birthday: @rider.birthday, country: @rider.country, name: @rider.name, tdf: @rider.tdf }
    assert_redirected_to rider_path(assigns(:rider))
  end
